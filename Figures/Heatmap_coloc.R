...
write.table(coloc_rst_PPH4, file = "/data/Choi_lung/scLongreads/colocalization/TableS4.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
x.axis.bar.df$Category <- c(rep("Epithelial",8), rep("Immune", 6), rep("Endothelial", 2))
